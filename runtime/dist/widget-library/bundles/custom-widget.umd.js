    ...
    ***************************************************************************** */
    ...
    var GpSmartEchartWidgetComponent = /** @class */ (function () {
        ...
        GpSmartEchartWidgetComponent.prototype.ngOnInit = function () {
            ...
            var sessionStorageData = this.getDataFromSessionStorage('Chartsession');
        ...
        GpSmartEchartWidgetComponent.prototype.createChart = function (userInput) {
            return __awaiter(this, void 0, void 0, function () {
                var chartsessionData, matchingURL_1, getDataFromSession, _a, sqlReqObject, response, _b, temp, _c, sqlReqObject, response, _d, axisFontSize, xAxisObject, yAxisObject, xAxisName, yAxisName, xAxisName, yAxisName, resultDimension, dimensions, encodeData, datasetId, yDimensions, xDimensions, yAxisName, xAxisName, xAxisName, yAxisName, yDimensions, xDimensions, indexOfXDimension, indicatorData, i, resultDimension, dimensions, encodeData, datasetId, yDimensions, xDimensions, xAxisName, yAxisName, xAxisName, yAxisName, yDimensions, xDimensions;
                var _this = this;
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            if (!(userInput.showApiInput || userInput.showDatahubInput)) return [3 /*break*/, 15];
                            chartsessionData = [];
                            if (!this.getDataFromSessionStorage('Chartsession')) return [3 /*break*/, 9];
                            ...
                            if (!!matchingURL_1) return [3 /*break*/, 8];
                            if (!(this.getDataFromSessionStorage('serviceRunning') === 'false')) return [3 /*break*/, 7];
                            this.setDataInSessionStorage('serviceRunning', 'true');
                            getDataFromSession = JSON.parse(sessionStorage.getItem('Chartsession'));
                        ...
                        case 9:
                            ...
                            temp = [];
                            if (!userInput.showApiInput) return [3 /*break*/, 11];
                            _c = this;
                            return [4 /*yield*/, this.chartService.getAPIData(userInput.apiUrl).toPromise()];
                        case 10:
                            _c.serviceData = _e.sent();
                            if (this.serviceData !== null) {
                            ...
                            return [3 /*break*/, 15];
                        case 11:
                            if (!userInput.showDatahubInput) return [3 /*break*/, 14];
                            sqlReqObject = {
                                sql: userInput.sqlQuery,
                                limit: userInput.sqlLimit,
                                format: 'PANDAS'
        ...
        GpSmartEchartWidgetComponent.prototype.getDataFromSessionStorage = function (key) {
        ...
        GpSmartEchartWidgetComponent.prototype.setDataInSessionStorage = function (key, data) {
            sessionStorage.setItem(key, JSON.stringify(data));
        };
        GpSmartEchartWidgetComponent.prototype.waitForServiceToComplete = function () {
            var _this = this;
            setTimeout(function () {
                var sessionStorageData = _this.getDataFromSessionStorage('Chartsession');
                if (sessionStorageData && sessionStorageData !== 'true' && _this.getDataFromSessionStorage('serviceRunning') === 'false') {
                    _this.createChart(_this.config);
                }
                else {
                    _this.waitForServiceToComplete();
                }
            }, 2000);
        };
        GpSmartEchartWidgetComponent.prototype.ngOnDestroy = function () {
